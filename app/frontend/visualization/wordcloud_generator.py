...
class WordCloudGenerator:
    ...
    def __init__(self):
        ...
        self.stop_words = {
            ...
            'me', 'te', 'se', 'nous', 'vous', 'se', 'moi', 'toi', 'lui', 'elle', 'nous', 'vous', 'eux',
            ...
            'émission', 'épisode', 'suite', 'cette', 'cest', 'jai', 'hâte', 'voir'
        }
        ...
        self.emotion_words = {
            ...
            'amazing', 'awesome', 'terrible', 'awful', 'wonderful', 'fantastic', 'incredible',
    ...
    def generate_emotion_wordcloud(self, 
        ...
        # Filtrer par émotion si spécifiée
        if emotion_filter:
            filtered_data = [(text, emotion) for text, emotion in zip(texts, emotions) 
                           if emotion == emotion_filter]
            if not filtered_data:
                return self._empty_wordcloud()
            texts, emotions = zip(*filtered_data)
    ...
    def generate_interactive_wordcloud(self, 
                                     data: List[Dict[str, Any]],
                                     emotion: Optional[str] = None) -> go.Figure:
